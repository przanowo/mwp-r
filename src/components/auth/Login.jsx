    ...
    <div className="h-screen w-screen snap-y overflow-scroll justify-center items-center">
      ...
      >
        <div className="flex flex-col bg-gray-300/50 rounded-lg p-16 w-1/2">
          ...
          <h1 className="text-3xl text-white font-bold p-4 text-center">Login</h1>
          <input
          ...
          <input
            ...
            />
          <button className="p-2 mt-2 bg-orange-400/50 hover:bg-orange-400 text-white rounded" onClick={handleLogin}>
            Login
          </button>
          <button className="p-2 mt-2 bg-red-500/75 hover:bg-red-500 text-white  rounded" onClick={handlesignInWithGoogle}>
            Login with Google
          </button>
          <button className="p-2 mt-2 bg-blue-500/75 hover:bg-blue-500 text-white rounded" onClick={handleLogin}>
            Login with Facebook
          </button>
          <button className="p-2 mt-2 text-white underline" onClick={handleForgotPassword}>
            Forgot password?
          </button>
        </div>
