...
const Checkout = () => {
  ...
  return (
    <div 
    className='flex-col bg-cover bg-center min-h-screen'
    style={{ backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/miniparfumqueen.appspot.com/o/images%2Fbg%2FcheckoutBG.jpg?alt=media&token=ca190154-dda4-4d8d-9344-e9b05f3cd370s")`}} 
    >
      <div className='flex mt-28 max-w-4xl justify-center items-center mx-auto text-xl font-semibold rounded bg-gray-200/50 my-4'>
        {!cartExpanded && (
          ...
          onClick={handleCartExpand}>Show Cart</button>
          )}
        {cartExpanded && <Cart />}
      ...
      <div 
        ...
        {!shippingExpanded && (
          <button className='flex items-center p-3 text-3xl' >Add Shipping Address</button>
        )}
